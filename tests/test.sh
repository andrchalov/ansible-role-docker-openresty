...
printf ${green}"Running command: docker exec $container_id env TERM=xterm ansible-playbook env ANSIBLE_FORCE_COLOR=1 /etc/ansible/roles/role_under_test/tests/$playbook"${neutral}
